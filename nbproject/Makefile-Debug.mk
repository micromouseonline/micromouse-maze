...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/micromouse-maze.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/micromouse-maze.exe: ${OBJECTFILES}
...
${OBJECTDIR}/BasicMaze.o: BasicMaze.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BasicMaze.o BasicMaze.cpp
...
${OBJECTDIR}/maze.o: maze.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maze.o maze.c

${OBJECTDIR}/mazeflooder.o: mazeflooder.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazeflooder.o mazeflooder.c

${OBJECTDIR}/mazepathfinder.o: mazepathfinder.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazepathfinder.o mazepathfinder.c

${OBJECTDIR}/mazeprinter.o: mazeprinter.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazeprinter.o mazeprinter.c

${OBJECTDIR}/mazereader.o: mazereader.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazereader.o mazereader.c

${OBJECTDIR}/mazesearcher.o: mazesearcher.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazesearcher.o mazesearcher.c
...
${TESTDIR}/gtest/src/gtest-all.o: gtest/src/gtest-all.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/gtest/src/gtest-all.o gtest/src/gtest-all.cc


${TESTDIR}/tests/testCosts.o: tests/testCosts.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testCosts.o tests/testCosts.cpp


${TESTDIR}/tests/testDirection.o: tests/testDirection.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testDirection.o tests/testDirection.cpp


${TESTDIR}/tests/testFlood.o: tests/testFlood.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testFlood.o tests/testFlood.cpp


${TESTDIR}/tests/testList.o: tests/testList.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testList.o tests/testList.cpp


${TESTDIR}/tests/testLocation.o: tests/testLocation.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testLocation.o tests/testLocation.cpp


${TESTDIR}/tests/testMaze.o: tests/testMaze.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testMaze.o tests/testMaze.cpp


${TESTDIR}/tests/testMazePrinter.o: tests/testMazePrinter.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testMazePrinter.o tests/testMazePrinter.cpp


${TESTDIR}/tests/testMazeReader.o: tests/testMazeReader.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testMazeReader.o tests/testMazeReader.cpp


${TESTDIR}/tests/testModifiedFlood.o: tests/testModifiedFlood.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testModifiedFlood.o tests/testModifiedFlood.cpp


${TESTDIR}/tests/testPathfinder.o: tests/testPathfinder.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testPathfinder.o tests/testPathfinder.cpp


${TESTDIR}/tests/testRunner.o: tests/testRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testRunner.o tests/testRunner.cpp


${TESTDIR}/tests/testSearcher.o: tests/testSearcher.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testSearcher.o tests/testSearcher.cpp


${TESTDIR}/tests/testWalls.o: tests/testWalls.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -std=c++11 -std=gnu++0x -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testWalls.o tests/testWalls.cpp
...
${OBJECTDIR}/BasicMaze_nomain.o: ${OBJECTDIR}/BasicMaze.o BasicMaze.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BasicMaze_nomain.o BasicMaze.cpp;\
	else  \
...
${OBJECTDIR}/list_nomain.o: ${OBJECTDIR}/list.o list.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/list_nomain.o list.c;\
	else  \
...
${OBJECTDIR}/maze_nomain.o: ${OBJECTDIR}/maze.o maze.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maze_nomain.o maze.c;\
	else  \
...
${OBJECTDIR}/mazeflooder_nomain.o: ${OBJECTDIR}/mazeflooder.o mazeflooder.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazeflooder_nomain.o mazeflooder.c;\
	else  \
...
${OBJECTDIR}/mazepathfinder_nomain.o: ${OBJECTDIR}/mazepathfinder.o mazepathfinder.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazepathfinder_nomain.o mazepathfinder.c;\
	else  \
...
${OBJECTDIR}/mazeprinter_nomain.o: ${OBJECTDIR}/mazeprinter.o mazeprinter.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazeprinter_nomain.o mazeprinter.c;\
	else  \
...
${OBJECTDIR}/mazereader_nomain.o: ${OBJECTDIR}/mazereader.o mazereader.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazereader_nomain.o mazereader.c;\
	else  \
...
${OBJECTDIR}/mazesearcher_nomain.o: ${OBJECTDIR}/mazesearcher.o mazesearcher.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazesearcher_nomain.o mazesearcher.c;\
	else  \
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/micromouse-maze.exe
