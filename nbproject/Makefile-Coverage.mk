...
${OBJECTDIR}/mazesearcher.o: mazesearcher.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazesearcher.o mazesearcher.c
...
${TESTDIR}/tests/testModifiedFlood.o: tests/testModifiedFlood.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I../../micromouse/micromouse-maze/gtest -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testModifiedFlood.o tests/testModifiedFlood.cpp
...
${OBJECTDIR}/mazesearcher_nomain.o: ${OBJECTDIR}/mazesearcher.o mazesearcher.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mazesearcher_nomain.o mazesearcher.c;\
	else  \
